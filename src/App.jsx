  ...
  return (
    <div className="container mx-auto max-w-7xl">
      ...
      <div
        className="
    fixed
    bottom-[max(theme(spacing.4),env(safe-area-inset-bottom))]  /* safe area */
    left-1/2 -translate-x-1/2
    z-50
    pointer-events-none  /* so clicks pass through outside the dock */
  "
      >
        <FloatingDock
          desktopClassName="pointer-events-auto rounded-full bg-white/10 backdrop-blur px-10 py-3 ring-1 ring-white/10"
          mobileClassName="pointer-events-auto rounded-full bg-white/10 backdrop-blur px-10 py-3 ring-1 ring-white/10"
          items={[
            {
              title: "LinkedIn",
            ...
            {
              title: "Dribbble",
              href: "https://dribbble.com/cristianharders",
              icon: (
                <svg
                  className="w-6 h-6 text-gray-800 dark:text-white"
                  aria-hidden="true"
            ...
            },
            {
              ...
              icon: (
                ...
                >
                  <svg
                    className="w-6 h-6 text-gray-800 dark:text-white hover:text-[#ed1313] transition-colors"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
