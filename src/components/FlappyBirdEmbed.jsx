...
export default function FlappyBirdEmbed() {
  ...
  return (
      <VisibilitySection className="min-h-screen grid place-items-center p-4">

  <h2 className="text-heading text-center text-6xl my-3">Time for a round of Flappy Bird!</h2>
  <div className="flex flex-row justify-center align-middle">

    <p className="mb-3 font-normal text-neutral-400">Built from scratch in Java!</p>
