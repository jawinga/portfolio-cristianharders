...
import VisibilitySection from "../minor-sections/VisibilitySection";
    ...
    <div className="c-space section-spacing min-h-[60vh]">
      <VisibilitySection>
        <div className="flex flex-col lg:flex-row justify-between items-center px-6 py-10 md:px-10 md:py-14 rounded-2xl gap-10">
          {/* LEFT: text */}
          <div className="flex flex-row items-center max-w-xl w-full gap-8">
            <div className="flex flex-col flex-1 text-center lg:text-left">
              <h2 className="text-3xl md:text-5xl font-extrabold">
                Let&apos;s Connect!
              </h2>
              <h3 className="mt-5 text-neutral-300 text-2xl">
                I’m open to frontend and full-stack roles, collaborations, and
                connecting with developers from all around the globe.
              </h3>
              <div
                className="flex flex-row gap-2 my-5 justify-center lg:justify-start"
                onClick={() => copyToClip("#email")}
              >
