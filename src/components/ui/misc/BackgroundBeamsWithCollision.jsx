...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
   "relative flex items-center w-full justify-center overflow-hidden z-0 bg-gradient-to-b",
  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "absolute left-0 top-20 m-auto h-24 w-[3px] rounded-full bg-gradient-to-t from-indigo-400 via-purple-400 to-transparent blur-[1px] opacity-90",
