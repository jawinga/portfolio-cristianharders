...
import { DirectionAwareHover } from "../components/ui/misc/DirectionAwareHover";
import { CodeEducation } from "../components/ui/minor-sections/CodeEducation";
import { SparklesText } from "../components/ui/text/SparklesText";
import { HoverButton } from "../components/ui/buttons/HoverButton";
import VisibilitySection from "../components/ui/minor-sections/VisibilitySection";
import Button from "../components/ui/buttons/Button";
import { InfiniteMovingCards } from "../components/ui/cards/InfiniteMovingCards";
    ...
    <div className="c-space section-spacing" id="education">
      ...
      <div className="flex flex-col mt-30 md:flex-row items-center justify-start gap-10 text-center md:text-left">
        ...
        <div className="relative h-[18rem] md:h-[24rem] flex flex-col gap-5 items-center justify-center w-full md:w-1/2">
          ...
          <Button
            label="Download Certificate of Higher Education"
            icon={DownloadButton}
